    ...
    return {
        ...
        renderCompletion: function(dontForceDisplay) {
            ...
            this.completion.style.top = window.pageYOffset + inputRect.top +
                inputRect.height - 1 + 'px';
            this.completion.style.left = inputRect.left + 5 + 'px';
            this.completion.style.display = 'block';
            this.completion.style.zIndex = '500';
        ...
        getContext: function(text, cursorPos) {
            ...
            if (prefix === ')' && !whitespace) {
                ...
                (lastToken.name === 'PAREN_L' && (!nextToLastToken || ['AND', 'OR'].indexOf(nextToLastToken.name) >= 0))) {
                scope = 'field';
                ...
                nextToLastToken && nextToLastToken.name === 'NAME' && ['EQUALS', 'NOT_EQUALS', 'CONTAINS', 'NOT_CONTAINS', 'GREATER_EQUAL',
            ...
            } else if (lastToken && whitespace && ['PAREN_R', 'INT_VALUE', 'FLOAT_VALUE', 'STRING_VALUE']
                .indexOf(lastToken.name) >= 0) {
                scope = 'logical';
            }
